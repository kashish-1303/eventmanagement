...
const PaymentForm = ({ booking }) => {
  ...
  //       // Optionally, simulate the payment update immediately if needed
  //       await PaymentService.updatePaymentStatus(createdPayment.payment_id, {
  //         status: 'SUCCESS',
  //         transaction_id: createdPayment.payment_id
  //       });
  ...
  const handleSubmit = async (e) => {
    ...
    setIsSubmitting(true);
    setError(null);
    console.log("Submitting payment for booking:", booking.booking_id);
