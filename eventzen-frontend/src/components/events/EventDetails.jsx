...
//         {/* Rest of your component remains the same but use currentEvent instead of event */}
...
//   // We'll fetch the event only if currentEvent is null or has a different ID
//   useEffect(() => {
//     if (!currentEvent || currentEvent.id !== eventId) {
//       dispatch(fetchEventById(eventId));
//     }
//   }, [eventId, dispatch, currentEvent]);
