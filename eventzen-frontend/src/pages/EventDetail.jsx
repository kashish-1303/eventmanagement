...
const EventDetail = () => {
  ...
  // Only fetch the event here once
  useEffect(() => {
    if (eventId) {
      console.log("EventDetail Page - Dispatching fetchEventById with ID:", eventId);
      dispatch(fetchEventById(eventId));
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          {/* Pass the event as a prop instead of letting EventDetails fetch it again */}
          <EventDetails event={event} isAuthenticated={isAuthenticated} />
